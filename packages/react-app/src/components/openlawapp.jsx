...
class OpenlawApp extends Component {
  
//initial state of variables for BillOfSale Template, and provider,etc
  state = { 
  ...
  componentDidMount = async () => {
    try {
      //Get network provider and ethers instance.
      ...
      // Set provider, accounts, and contract to the state, and then proceed with an
      // example of interacting with the contract's methods.
      this.setState({ provider, accounts, contract: instance }, this.runExample);
