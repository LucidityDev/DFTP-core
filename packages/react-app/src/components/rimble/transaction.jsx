import { Loader, Tooltip, Modal, Card, Box, Flex, Icon, Text, Link, Heading, Button  } from "rimble-ui";
import React, { useState } from 'react';

export const TransactionPopUp = (props) => {
    const [start, changeStatus] = useState()
